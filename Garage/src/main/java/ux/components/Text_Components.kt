...
fun field_input(Primary_Text: MutableState<String>, Title:String="", Hint:String="", KeyType:KeyboardType= KeyboardType.Text){
    ...
    TextField(value = Primary_Text.value, keyboardOptions = KeyboardOptions(keyboardType =KeyType ), label = { Text(text = Title)}, placeholder = { Text(text = Hint)}, onValueChange ={ input->Primary_Text.value=input} )
}
